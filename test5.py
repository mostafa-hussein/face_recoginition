...
class MultiRoomPersonTracker(Node):
    def __init__(self, cam_ports, database_path, display_size=(640, 480), ros_topic='person_at'):
        ...
        # Face embedding
        self.target_embedding = self._load_target_embedding(database_path)
    ...
    def _load_target_embedding(self, database_path = "face_database_lab_2.pkl"):
        import pickle
...
def main():
    ...
    try:
        ...
        tracker_node = MultiRoomPersonTracker(
            cam_ports=cam_ports,
            database_path="face_database_lab_2.pkl",
